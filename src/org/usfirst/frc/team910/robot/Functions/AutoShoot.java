	...
	public void run() {
		if (in.autoShoot){										//when we hit the auto shoot button
			...
			case CAM_CHECK:
				...
				break;
			case DRIVE:
				drive.originAngle.set(sense.robotAngle.get() + sense.cameraAngle.get());	//set our origin angel toward the target
			...
			case PRIME:
				...
				break;
			case FIRE:
				shoot.shooterFire(true);// TODO see comment above.	//fire
			}
