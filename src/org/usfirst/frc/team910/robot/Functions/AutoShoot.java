	...
	public void run() {
		if (in.autoShoot){
			...
			case DRIVE:
				...
				if (Math.abs(currentTarget.distance - SHOOT_DISTANCE) < ALLOWABLE_DISTANCE_ERROR) { // when camera class is done we will get the distance of the camera to be < 0.05
