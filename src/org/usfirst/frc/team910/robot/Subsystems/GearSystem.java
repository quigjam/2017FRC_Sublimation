...
public class GearSystem {
	...
	private static final double SCORE_POSITION_L =509;//581; //END OF SHEPARD 581; //prac bot:469; // 581 //596 //578 //TODO change the pot values back to the comp bot pot values
														// //460; //pot values
	private static final double SCORE_POSITION_R = -418;//-364; // END OF SHEPARD -364;//prac bot:-398; // 364 //-342 //-368
															// //-850;
